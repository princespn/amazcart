...
<body style="background-color: white;">
    <section class="main-body">
        <div class="badge" style="position: absolute;top: 10px;right: -40px;font-size: 18px; background: {{$order->is_paid == 1 ? '#01B871' : 'rgb(251, 71, 71)'}} ; color: #fff;
        padding: 5px 10px;
        min-width: 150px;
        transform: rotate(39deg);
        text-align: center;
        text-transform: capitalize;">{{ __('order.paid') }} - {{$order->is_paid == 1 ? 'Yes' : 'No'}}</div>
            ...
            <table class="info">
                <tr>
                    ...
                    <td class="info-right">
                        <table>
                            <tr>
                                <td>{{__('defaultTheme.invoice_number')}}</td>
                        ...
                        <table class="bg-dark">
                            ...
                            <tr>
                                <td>{{__('gst.gst_or_vat_number')}}</td>
                                <td>{{app('general_setting')->gst_number}}</td>
                            </tr>
                            @endif
                            <tr>
            ...
            <div>
                @foreach ($order->packages as $key => $order_package)
                    ...
                    <table class="invoice-list">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="4">{{ __('order.subtotal') }}:</td>
